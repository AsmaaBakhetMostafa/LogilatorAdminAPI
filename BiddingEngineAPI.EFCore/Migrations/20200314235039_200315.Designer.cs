...
namespace BiddingEngineAPI.EFCore.Migrations
{
    ...
    [Migration("20200314235039_200315")]
    partial class _200315
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiddingEngineAPI.EFCore.Model.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BiddingEngineAPI.EFCore.Model.ChatMessage", b =>
                {
                    b.HasOne("BiddingEngineAPI.EFCore.Model.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId");

                    b.HasOne("BiddingEngineAPI.EFCore.Model.User", "ToUser")
                        .WithMany()
